    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.MapWhen(c => c.Request.Path == "/", a =>
            {
                a.Run(async x =>
                {
                    await x.Response.WriteAsync($"<html><body><h1>{this.GetType().Namespace}!!!1</h1><p><a href='/health'>health</a>&nbsp;<a href='/liveness'>liveness</a></p></body></html>").ConfigureAwait(false);
                });
            });
